			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1>
								<i class="icon-leaf green"></i> <span class="red">微信公众号</span> <span
									class="white">管理系统</span>
							</h1>
							<h4 class="blue">&copy; Company 十五度工作室</h4>
						</div>
											...
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" placeholder="用户名" id="username" name="username"/> <i
														class="icon-user"></i>
												</span>
												...
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" placeholder="验证码" style="width: 55%;float: left;" id="vcode" name="vcode"/> 
												<img src="randomCode" id="imc" onclick="randomCode()" style="float: left;width: 45%;height: 34px;padding-left: 10%;" />
												</span>
												</label>
									...
									<div class="widget-main">
										...
										<form>
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="email" class="form-control" placeholder="请输入注册邮箱" />
